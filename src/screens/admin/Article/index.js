        ...
        <div className='home-admin'>
            ...
            <div className="info-articles">
                <div className="form-add">
                    {/* <Link className="btn-article btn-add" href={routers.addArticleAdmin}>Agregar publicacion</Link> */}
                </div>
                <div>
                        ...
                        <div className="table-articles">
                            ...
                            {displayedArticles.map((item, index) => (
                                <div key={index} className="row body-table">
                                    ...
                                    <div className="col">
                                        <Link className='btn-edit'href={`/src/Page/Admin/Article/${item.id}`}>Editar</Link>
                                    </div>
                                    <div className="col">
